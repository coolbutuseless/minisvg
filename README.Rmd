...
* [Creating and Animating the a seventies wallpaper pattern](https://coolbutuseless.github.io/package/minisvg/articles/wallpaper-01.html)
* [Some example of filter usage](https://coolbutuseless.github.io/package/minisvg/articles/filter-effects)
...
if (interactive()) {
  pat$show()
  pat$save_full_svg("man/figures/README-svgpattern.svg", width=250, height = 100)
} 
```
...
if (interactive()) {
  pat$show()
  pat$save_full_svg("man/figures/README-svgpattern-filter.svg", width=250, height = 100)
} 
```
