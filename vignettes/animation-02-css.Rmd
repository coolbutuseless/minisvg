...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
doc$css_url <- "https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.2/animate.min.css"
```
...
```{r}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Need to use `include_declarations = TRUE` here as the external CSS
# declaration is part of the XML declaration header which comes *before*
# the opening <svg> tag.
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
doc$save("svg/animation-css.svg", include_declaration = TRUE)
```

I have to include a gif animation here because the CSS location in the 
XML declaration does not seem to be parsed when rendered within a document, 
but does render OK if you [load the SVG in a web browser directly](svg/animation-css.svg)

<img src = "images/animation-css.gif">
