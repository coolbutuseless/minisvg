...
element_info <- list(
  ...
  feBlend             = c("in", "in2", "mode"),
  feColorMatrix       = c("in", "type", "values"),
  feComponentTransfer = c("in"),
  feComposite         = c("in", "in2", "operator", "k1", "k2", "k3", "k4"),
  feConvolveMatrix    = c("in", "order", "kernelMatrix", "divisor", "bias", "targetX", "targetY", "edgeMode", "kernelUnitLength", "preserveAlpha"),
  feDiffuseLighting   = c("in", "surfaceScale", "diffuseConstant", "kernelUnitLength"),
  feDisplacementMap   = c("in", "in2", "scale", "xChannelSelector", "yChannelSelector"),
  feFlood             = c("flood_color", "flood_opacity"),
  feGaussianBlur      = c("in", "stdDeviation", "edgeMode"),
  feImage             = c("preserveAspectRatio", "xlink_href"),
  feMerge             = c(),
  feMorphology        = c("in", "operator", "radius"),
  feOffset            = c("in", "dx", "dy"),
  feSpecularLighting  = c("in", "surfaceScale", "specularConstant", "specularExponent", "kernelUnitLength"),
  feTile              = c("in"),
  feTurbulence        = c("type", "baseFrequency", "numOctaves", "result", "seed", "stitchTiles"),
